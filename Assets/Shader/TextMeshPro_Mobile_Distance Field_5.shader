...
RV_0a7c410bedac_Output RecoveryVertex(RV_0a7c410bedac_Input input)
{
    RV_0a7c410bedac_Output output;
    float2 u_xlat0;
    bool u_xlatb0;
    float4 u_xlat1;
    float4 u_xlat2;
    ...
    u_xlatb21 = transpose(glstate_matrix_projection)[3].w==0.0;
    ...
    output.COLOR1.xyz = mad(u_xlat4.xyz, u_xlat4.www, u_xlat5.xyz);
    output.COLOR1.w = mad(u_xlat3.w, _FaceColor.w, u_xlat5.w);
    ...
    output.TEXCOORD1.y = mad((-u_xlat21), 0.5, u_xlat2.w);
    output.TEXCOORD1.z = mad(u_xlat21, 0.5, u_xlat2.w);
    ...
    output.TEXCOORD4.y = mad((-u_xlat14), 0.5, u_xlat0.x);
    return output;
}



struct RF_199aaa8a670e_Input
{
    float4 COLOR0 : COLOR0;
    float4 TEXCOORD0 : TEXCOORD0;
    float4 TEXCOORD1 : TEXCOORD1;
...
struct RF_199aaa8a670e_Output
{
    float4 SV_Target0 : SV_Target0;
};

RF_199aaa8a670e_Output RecoveryFragment(RF_199aaa8a670e_Input input)
{
    RF_199aaa8a670e_Output output;
    float4 u_xlat0;
    float4 u_xlat1;
    float4 u_xlat2;
    u_xlat0.x = _MainTex.Sample(sampler_MainTex, input.TEXCOORD3.xy).w;
    u_xlat0.x = mad(u_xlat0.x, input.TEXCOORD4.x, (-input.TEXCOORD4.y));
    ...
    u_xlat1.x = mad(u_xlat1.x, input.TEXCOORD1.x, (-input.TEXCOORD1.w));
    u_xlat1.x = clamp(u_xlat1.x, 0.0f, 1.0f);
    u_xlat2 = u_xlat1.xxxx * input.COLOR0;
    u_xlat1.x = mad((-input.COLOR0.w), u_xlat1.x, 1.0);
