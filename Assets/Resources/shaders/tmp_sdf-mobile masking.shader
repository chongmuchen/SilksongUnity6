...
// Original serialized Shader SHA256: f354f7ee5a3906ec509859e762fc0080449235f24dab2ea0ce1842bcf9dd99bd
...
Shader "TextMeshPro/Mobile/Distance Field - Masking"
{
    Properties
    {
        ...
        _MaskEdgeSoftness ("Edge Softness", Range(0, 1)) = 0.00999999978
...
#if (1)
            // Original Metal program SHA256: vertex 3614bdafcdb4808f6cee878ac7b8c8a1d631fcff3fe3f7612fd6bd3ab4ca10b9; fragment aa3e78d1e2593c9607c10209b5ed4a911e5f2b78de375d0810d01ff50e29c788.
...
struct RF_aa3e78d1e259_Output
{
    float4 SV_Target0 : SV_Target0;
};

RF_aa3e78d1e259_Output RecoveryFragment(RF_aa3e78d1e259_Input input)
{
    RF_aa3e78d1e259_Output output;
    float u_xlat0;
    float4 u_xlat1;
    float4 u_xlat2;
    float3 u_xlat3;
    ...
    u_xlat0 = mad(u_xlat4.x, _MaskEdgeSoftness, abs(u_xlat0));
    ...
    u_xlat8 = mad(u_xlat8, input.TEXCOORD1.x, (-input.TEXCOORD1.w));
    u_xlat8 = clamp(u_xlat8, 0.0f, 1.0f);
    u_xlat1 = ((float4)(u_xlat8)) * input.COLOR0;
    u_xlat2.w = u_xlat4.x * u_xlat1.w;
    u_xlat3.xyz = u_xlat2.www * _MaskEdgeColor.xyz;
    u_xlat4.xyz = mad(u_xlat1.xyz, u_xlat4.xxx, (-u_xlat3.xyz));
    u_xlat2.xyz = mad(((float3)(u_xlat0)), u_xlat4.xyz, u_xlat3.xyz);
