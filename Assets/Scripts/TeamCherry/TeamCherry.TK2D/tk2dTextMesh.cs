...
public class tk2dTextMesh : MonoBehaviour, ISpriteCollectionForceBuild
{
	...
	public Bounds GetEstimatedMeshBoundsForString(string str)
	{
		...
		return new Bounds(new Vector3(xAnchorForWidth + meshDimensionsForString.x * 0.5f, yAnchorForHeight + meshDimensionsForString.y * 0.5f + num, 0f), Vector3.Scale((Vector3)meshDimensionsForString, new Vector3(1f, -1f, 1f)));
	}
