		...
		foreach (tk2dBatchedSprite tk2dBatchedSprite2 in array3)
		{
			...
			if (flag)
			{
				...
				foreach (tk2dCollider2DData tk2dCollider2DData2 in edgeCollider2D)
				{
					...
					{
						array4[n] = matrix4x.MultiplyPoint((Vector3)tk2dCollider2DData2.points[n]);
					}
				...
				foreach (tk2dCollider2DData tk2dCollider2DData3 in edgeCollider2D)
				{
					...
					{
						array5[num3] = matrix4x.MultiplyPoint((Vector3)tk2dCollider2DData3.points[num3]);
					}
			...
			else if (flag2)
			{
				...
				array[0] = matrix4x.MultiplyPoint((Vector3)new Vector2(vector3.x, vector3.y));
				array[1] = matrix4x.MultiplyPoint((Vector3)new Vector2(vector4.x, vector3.y));
				array[2] = matrix4x.MultiplyPoint((Vector3)new Vector2(vector4.x, vector4.y));
				array[3] = matrix4x.MultiplyPoint((Vector3)new Vector2(vector3.x, vector4.y));
				array[4] = array[0];
