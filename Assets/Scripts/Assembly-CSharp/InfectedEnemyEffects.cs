...
public class InfectedEnemyEffects : MonoBehaviour, IHitEffectReciever
{
	...
	public void ReceiveHitEffect(HitInstance hitInstance)
	{
		...
		case 0:
			if (!noBlood)
			{
				BloodSpawner.SpawnBlood(base.transform.position + effectOrigin, 3, 4, 10f, 15f, 120f, 150f);
				BloodSpawner.SpawnBlood(base.transform.position + effectOrigin, 8, 15, 10f, 25f, 30f, 60f);
			}
		...
		case 2:
			if (!noBlood)
			{
				BloodSpawner.SpawnBlood(base.transform.position + effectOrigin, 3, 4, 10f, 15f, 30f, 60f);
				BloodSpawner.SpawnBlood(base.transform.position + effectOrigin, 8, 10, 15f, 25f, 120f, 150f);
			}
		...
		case 1:
			if (!noBlood)
			{
				BloodSpawner.SpawnBlood(base.transform.position + effectOrigin, 8, 10, 20f, 30f, 80f, 100f);
			}
		...
		case 3:
			if (!noBlood)
			{
				BloodSpawner.SpawnBlood(base.transform.position + effectOrigin, 4, 5, 15f, 25f, 140f, 180f);
				BloodSpawner.SpawnBlood(base.transform.position + effectOrigin, 4, 5, 15f, 25f, 360f, 400f);
			}
