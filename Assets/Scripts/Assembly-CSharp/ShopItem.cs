...
public class ShopItem : ScriptableObject
{
	...
	public bool IsPurchased
	{
		get
		{
			...
			if (!string.IsNullOrEmpty(playerDataIntName) && instance.GetVariable<BellhomePaintColours>(playerDataIntName) != BellhomePaintColours.None)
			{
				return true;
			}
	...
	public void SetPurchased(Action onComplete, int subItemIndex)
	{
		...
		if ((typeFlags & TypeFlags.Map) != TypeFlags.None)
		{
