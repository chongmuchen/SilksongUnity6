...
namespace HutongGames.PlayMaker.Actions
{
	public class HeroTurnToFace : FsmStateAction
	{
		...
		public override void OnEnter()
		{
			...
			hc.FlipSprite();
			tk2dSpriteAnimator obj = heroAnimator;
			obj.AnimationCompleted = (Action<tk2dSpriteAnimator, tk2dSpriteAnimationClip>)Delegate.Combine(obj.AnimationCompleted, new Action<tk2dSpriteAnimator, tk2dSpriteAnimationClip>(OnHeroAnimationCompleted));
		}
		...
		public override void OnExit()
		{
			...
			{
				tk2dSpriteAnimator obj = heroAnimator;
				obj.AnimationCompleted = (Action<tk2dSpriteAnimator, tk2dSpriteAnimationClip>)Delegate.Remove(obj.AnimationCompleted, new Action<tk2dSpriteAnimator, tk2dSpriteAnimationClip>(OnHeroAnimationCompleted));
				heroAnimator = null;
			}
		}
