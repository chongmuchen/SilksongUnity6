	...
	public abstract class CheckHeroPerformanceRegionBase : FsmStateAction
	{
		...
		protected void DoAction(bool isDelayed)
		{
			...
			else
			{
				...
				if (affectedState == HeroPerformanceRegion.AffectedState.None && this.affectedState != HeroPerformanceRegion.AffectedState.None && (bool)enemySingDuration && !enemySingDuration.CheckCanSing())
				{
					this.affectedState = HeroPerformanceRegion.AffectedState.None;
				}
