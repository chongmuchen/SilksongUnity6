...
namespace HutongGames.PlayMaker.Actions
{
	public class Tk2dPlayAnimationWaitV2 : FsmStateAction
	{
		...
		public override void OnEnter()
		{
			...
			tk2dSpriteAnimator obj = sprite;
			obj.AnimationCompleted = (Action<tk2dSpriteAnimator, tk2dSpriteAnimationClip>)Delegate.Combine(obj.AnimationCompleted, new Action<tk2dSpriteAnimator, tk2dSpriteAnimationClip>(AnimationCompleteDelegate));
		}
		...
		public override void OnExit()
		{
			...
			{
				tk2dSpriteAnimator obj = sprite;
				obj.AnimationCompleted = (Action<tk2dSpriteAnimator, tk2dSpriteAnimationClip>)Delegate.Remove(obj.AnimationCompleted, new Action<tk2dSpriteAnimator, tk2dSpriteAnimationClip>(AnimationCompleteDelegate));
			}
		}
