...
public class Breakable : DebugDrawColliderRuntimeAdder, IHitResponder, IBreakerBreakable
{
	...
	public void Break(float flingAngleMin, float flingAngleMax, float impactMultiplier)
	{
		...
		FlingUtils.SpawnAndFling(new FlingUtils.Config
		{
			...
			AmountMin = smallGeoDrops.Start,
			AmountMax = smallGeoDrops.End,
			SpeedMin = speedMin,
			SpeedMax = speedMax,
			AngleMin = angleMin,
			AngleMax = angleMax
		}, base.transform, effectOffset);
		FlingUtils.SpawnAndFling(new FlingUtils.Config
		{
			Prefab = Gameplay.MediumGeoPrefab,
			AmountMin = mediumGeoDrops.Start,
			AmountMax = mediumGeoDrops.End,
			SpeedMin = speedMin,
			SpeedMax = speedMax,
			AngleMin = angleMin,
			AngleMax = angleMax
		...
		FlingUtils.SpawnAndFling(new FlingUtils.Config
		{
			...
			AmountMin = largeGeoDrops.Start,
			AmountMax = largeGeoDrops.End,
			SpeedMin = speedMin,
			SpeedMax = speedMax,
			AngleMin = angleMin,
			AngleMax = angleMax
		...
		FlingUtils.SpawnAndFling(new FlingUtils.Config
		{
			...
			AmountMin = largeSmoothGeoDrops.Start,
			AmountMax = largeSmoothGeoDrops.End,
			SpeedMin = speedMin,
			SpeedMax = speedMax,
			AngleMin = angleMin,
			AngleMax = angleMax
		...
		FlingUtils.SpawnAndFlingShellShards(new FlingUtils.Config
		{
			...
			AmountMin = shellShardDrops.Start,
			AmountMax = shellShardDrops.End,
			SpeedMin = speedMin,
			SpeedMax = speedMax,
			AngleMin = angleMin,
			AngleMax = angleMax
