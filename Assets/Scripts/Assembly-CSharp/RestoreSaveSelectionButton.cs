...
public class RestoreSaveSelectionButton : MenuButton, ISubmitHandler, IEventSystemHandler, IPointerClickHandler, ISelectHandler, ICancelHandler
{
	...
	public override void OnMove(AxisEventData eventData)
	{
		...
		else if (eventData.moveDir == MoveDirection.Right && (base.navigation.selectOnRight == null || !base.navigation.selectOnRight.gameObject.activeInHierarchy))
		{
			eventData.selectedObject = GetBackButton();
			parentDisplay.OnDeselectButton(this);
		}
		else if (eventData.moveDir == MoveDirection.Left && (base.navigation.selectOnLeft == null || !base.navigation.selectOnLeft.gameObject.activeInHierarchy))
		{
			eventData.selectedObject = GetBackButton();
			parentDisplay.OnDeselectButton(this);
		}
