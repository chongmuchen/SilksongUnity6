...
namespace TMProOld
{
	...
	public class TMP_SubMesh : MonoBehaviour
	{
		...
		public Material material
		{
			...
			set
			{
				if (m_sharedMaterial.GetLegacyInstanceId() != value.GetLegacyInstanceId())
				{
		...
		public static TMP_SubMesh AddSubTextObject(TextMeshPro textComponent, MaterialReference materialReference)
		{
			...
			obj.hideFlags = HideFlags.DontSaveInEditor | HideFlags.NotEditable | HideFlags.DontSaveInBuild;
		...
		private void Awake()
		{
			clipRect = base.gameObject.GetComponentInParent<TextMeshProClipRect>();
			if ((bool)clipRect)
			{
				clipRect.AddSubMesh(this);
			}
		}
		...
		private Material GetMaterial(Material mat)
		{
			...
			if (m_material == null || m_material.GetLegacyInstanceId() != mat.GetLegacyInstanceId())
			{
