...
{
	public const string GAME_VERSION = "1.0.30000";
	...
	public const int FLEA_FESTIVAL_SETH_DODGE = 90;
	...
	public const int DEFAULT_VIDEO_DITHERING = 1;

	public const bool DEFAULT_VIDEO_NOISE = false;
	...
	public const string GSKEY_VIDEO_DITHERING = "VidDithering";

	public const string GSKEY_VIDEO_NOISE = "VidNoise";
	...
	public const string GSKEY_INPUT_NATIVE = "NativeInput";

	public const string GSKEY_INPUT_XINPUT = "XInput";

	public const string GSKEY_INPUT_MFI = "AppleMFi";
