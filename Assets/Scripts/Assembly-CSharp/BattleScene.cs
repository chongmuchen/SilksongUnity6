...
public class BattleScene : MonoBehaviour
{
	...
	[SerializeField]
	private bool skipSaveIfPlayerIsDead;
	...
	private void Awake()
	{
		...
		{
			for (int num = 0; num < initialisables.Length; num++)
			{
				initialisables[num].OnAwake();
			}
		}
