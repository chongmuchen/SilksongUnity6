...
public class HitResponse : HitResponseBase, IHitResponder, IBreakerBreakable
{
	...
	public IHitResponder.HitResponse Hit(HitInstance damageInstance)
	{
		...
		if (ignoreMultiHit && damageInstance.HitEffectsType != EnemyHitEffectsProfile.EffectsTypes.Full)
		{
			return IHitResponder.Response.None;
		}
	...
	{
		if ((unconditionallyAllowedTypes & damageInstance.SpecialType) != SpecialTypes.None)
		{
			return true;
		}
