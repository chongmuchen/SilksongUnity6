...
public class JoinedLevers : MonoBehaviour
{
	...
	private void OnSetSaveState(bool value)
	{
		...
		if ((bool)animator && animator.HasParameter(_activateAnimParam))
		{
	...
	public void ResetLevers()
	{
		...
		if ((bool)animator && animator.HasParameter(_resetAnimParam))
		{
	...
	public void PlayHitAnim()
	{
		if ((bool)animator)
		{
			...
			if (shortNameHash != _hitCAnim && shortNameHash != _hitCcAnim && animator.HasParameter(_hitAnimParam))
			{
