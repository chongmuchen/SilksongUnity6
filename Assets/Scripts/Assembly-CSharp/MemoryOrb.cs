...
public class MemoryOrb : MonoBehaviour
{
	...
	private void Collect()
	{
		...
		int collectedCloverMemoryOrbs = instance.CollectedCloverMemoryOrbs;
		if ((bool)orbGroup)
		{
		...
		int collectedCloverMemoryOrbs2 = instance.CollectedCloverMemoryOrbs;
		StartCoroutine(CollectRoutine((collectedCloverMemoryOrbs2 > collectedCloverMemoryOrbs) ? collectedCloverMemoryOrbs2 : 0));
	}

	private IEnumerator CollectRoutine(int orbCount)
	{
