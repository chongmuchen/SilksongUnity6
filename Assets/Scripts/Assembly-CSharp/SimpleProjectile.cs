...
public class SimpleProjectile : MonoBehaviour
{
	...
	[SerializeField]
	private bool randomBinaryDamage;

	[SerializeField]
	private Vector2 randomDamageRange;
	...
	private void Update()
	{
		...
		if ((bool)damager && randomBinaryDamage)
		{
			if (Random.Range(1, 100) <= 50)
			{
				damager.damageDealt = (int)randomDamageRange.x;
			}
			else
			{
				damager.damageDealt = (int)randomDamageRange.y;
			}
		}
