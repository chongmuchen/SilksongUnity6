...
public sealed class HeroVibrationController : MonoBehaviour
{
	...
	{
		VibrationManager.PlayVibrationClipOneShot(footStepVibration);
	}
	...
	{
		VibrationManager.PlayVibrationClipOneShot(airDashVibration);
	}
	...
	{
		shuttleClockEmission = VibrationManager.PlayVibrationClipOneShot(shuttleCockJumpVibration);
	}
	...
	{
		VibrationManager.PlayVibrationClipOneShot(heroDeathVibration);
	}

	public void PlayHeroHazardDeath()
	{
		VibrationManager.PlayVibrationClipOneShot(heroHazardDeathVibration);
	}
	...
	{
		VibrationManager.PlayVibrationClipOneShot(swimEnter);
	...
	{
		VibrationManager.PlayVibrationClipOneShot(swimExit);
		swimLoopEmission?.Stop();
		swimLoopFastEmission?.Stop();
	...
	{
		VibrationManager.PlayVibrationClipOneShot(toolThrowVibration);
	}
	...
	private void UpdateSwimSpeed(bool isSwimming, bool isSprinting)
	{
		if (isSwimming)
		{
			if (isSprinting)
			{
				...
				VibrationManager.PlayVibrationClipOneShot(fastSwimStart);
			}
			else
			{
