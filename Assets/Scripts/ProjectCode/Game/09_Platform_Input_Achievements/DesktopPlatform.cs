...
public class DesktopPlatform : Platform, VibrationManager.IVibrationMixerProvider
{
	...
	public override bool IsSaveStoreMounted
	{
		get
		{
			...
			{
				return onlineSubsystem.IsSaveStoreMounted;
			}
			return base.IsSaveStoreMounted;
		}
	}
	...
	public override bool IsSharedDataMounted
	{
		get
		{
			if (onlineSubsystem != null)
			{
				return onlineSubsystem.IsSharedDataMounted;
			}
			return base.IsSharedDataMounted;
		}
	}
	...
	public override AcceptRejectInputStyles GetAcceptRejectInputStyle(GamepadType gamepadType)
	{
		if ((uint)(gamepadType - 9) <= 1u || (uint)(gamepadType - 14) <= 1u)
		{
			return AcceptRejectInputStyles.JapaneseStyle;
		}
