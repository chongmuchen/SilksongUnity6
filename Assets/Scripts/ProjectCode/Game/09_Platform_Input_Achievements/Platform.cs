...
public abstract class Platform : MonoBehaviour
{
	...
	public virtual bool UseAsyncSaveFileLoad => false;
	...
	public virtual float SaveAndQuitFadeInDelay => 0f;
	...
	public virtual void SetTargetFrameRate(int frameRate)
	{
		...
		if (num % frameRate == 0)
		{
			Current.VSyncCount = num / frameRate;
		}
		else
		{
			Current.VSyncCount = 0;
		}
