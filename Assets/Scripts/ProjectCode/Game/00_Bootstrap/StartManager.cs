...
public class StartManager : MonoBehaviour
{
    ...
    [SerializeField] private StandaloneLoadingSpinner loadSpinnerPrefab;

    [Header("Language Select")] [SerializeField]
    private Camera camera;

    [SerializeField] private AddressableReferenceGameObject<LanguageSelector> languageSelectorReference;
    ...
    private IEnumerator Start()
    {
        ...
        if (isLoadingLanguageSelect)
        {
            ...
            languageSelectorHandle = languageSelectorReference.InstantiateAsyncCustom(base.transform, delegate
            {
                ...
                {
                    Debug.LogError($"Failed to load language selector. {languageSelectorHandle.OperationException}",
                        this);
                }
            });
            yield return null;
        ...
        bool showLoadingIcon = platform == RuntimePlatform.PS4 || platform == RuntimePlatform.XboxOne ||
        ...
        if (flag2)
        {
            ...
            ChangePositionByLanguage[] array2 =
                Object.FindObjectsByType<ChangePositionByLanguage>(FindObjectsSortMode.None);
            ...
            SetTextMeshProGameText[] componentsInChildren =
                GetComponentsInChildren<SetTextMeshProGameText>(includeInactive: true);
