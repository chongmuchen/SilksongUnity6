...
public static class SaveDataUtility
{
	...
	public static string SerializeSaveData<T>(T saveData, Action<JsonSerializer> changeSerializerSettings = null)
	{
		if (changeSerializerSettings != null)
		{
			_serializer = null;
		}
		CreateJsonObjects();
		changeSerializerSettings?.Invoke(_serializer);
