...
namespace UnityEngine.UI
{
	public class MenuSelectable : Selectable, ISelectHandler, IEventSystemHandler, IDeselectHandler, ICancelHandler, IPlaySelectSound
	{
		...
		public void OnCancel(BaseEventData eventData)
		{
			...
			if (cancelAction != CancelAction.DoNothing || hasCancelEventTrigger)
			{
				ForceDeselect();
			}
			if (!parentList)
			...
			case CancelAction.ApplyControllerSettings:
				...
				break;
			case CancelAction.ApplyAdvancedControllerSettings:
				if (!instance.UIGoBack())
				{
					instance.ApplyAdvancedControllerMenuSettings();
				}
				break;
		...
		protected void PlaySubmitSound()
		{
			...
			{
				VibrationManager.PlayVibrationClipOneShot(menuSubmitVibration.VibrationData);
			}
		}
		...
		protected void PlayCancelSound()
		{
			...
			{
				VibrationManager.PlayVibrationClipOneShot(menuCancelVibration.VibrationData);
			}
		}
