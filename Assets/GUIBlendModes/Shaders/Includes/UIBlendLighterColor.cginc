// Sprite texture with vertex tint: LighterColor.
...
float4 UIBlendFragment(UIBlendFragmentInput input) : SV_Target0
{
    ...
    float sourceLuminance = dot(sourceColor.xyz, float3(0.298999995, 0.587000012, 0.114));
    bool useBackground = sourceLuminance < backgroundLuminance;
    outputColor.xyz = useBackground ? backgroundColor : sourceColor.xyz;
