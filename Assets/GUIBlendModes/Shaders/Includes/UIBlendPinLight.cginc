// Sprite texture with vertex tint: PinLight.
...
float4 UIBlendFragment(UIBlendFragmentInput input) : SV_Target0
{
    ...
    float3 doubledSourceOffset = alphaAndMidpointOffsets.yzw + alphaAndMidpointOffsets.yzw;
    ...
    float3 lightBranch = max(doubledSourceOffset, backgroundColor);
    float3 doubledSource = sourceAlphaRGB.yzw + sourceAlphaRGB.yzw;
