// Sprite texture with vertex tint: VividLight.
...
float4 UIBlendFragment(UIBlendFragmentInput input) : SV_Target0
{
    ...
    float3 dodgeDenominator = mad((-alphaAndMidpointOffsets.yzw), float3(2.0, 2.0, 2.0), float3(1.0, 1.0, 1.0));
    ...
    float3 burnDenominator = sourceAlphaRGB.yzw + sourceAlphaRGB.yzw;
